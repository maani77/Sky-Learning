...
namespace MyProject.Controllers
{
    public class AnswerChoicesController : Controller
    {
        ...
        {
            ViewBag.QuestionId = new SelectList(from  s in db.Questions.Include(m => m.Quiz).ToList() select new {
            QuestionId = s.QuestionId, QuestionText = s.QuestionText + "-" + s.Quiz.QuizName}, "QuestionId", "QuestionText");
            return View();
        }
