...
namespace MyProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            _MyContext = new ApplicationDbContext();
        }
        ...
        public async Task<ActionResult> ConfirmEmail(string Token, string Email)
        {
            ...
            if (user != null)
            {
                if (user.Email == Email)
                {
                    ...
                    var folder = Server.MapPath("~/Content/Uploads/" + Email);
                    ...
                    if (userManager.IsInRole(user.Id,"Lecturer"))
                    {
                        var uploadDir = Server.MapPath("~/Content/Uploads/Lecturers/" + user.Email + "/");
        ...
        {
            ViewData["Name"] = new SelectList(_MyContext.Roles.ToList(),"Name","Name"); 
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    new System.Net.Mail.MailAddress("Admin@skylearning.com", "Sky Learning"),
                    ...
                    smtp.Credentials = new System.Net.NetworkCredential("omairmunir@gmail.com", "sardarrr123");
                    smtp.EnableSsl = true;
                    smtp.Send(m);
